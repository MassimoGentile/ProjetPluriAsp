...
namespace ProjetPluriAsp.Models
{
    ...
    public class BddContextInitializer : DropCreateDatabaseIfModelChanges<BddContext>
    {
        protected override void Seed(BddContext bdd)
        {
            ...
            bdd.T_Ingredient.Add(new CIngredient { Name = "Salade", Price = 2.5 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Tomate", Price = 2.35 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Côte de porc", Price = 7.12 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Filet de poulet", Price = 4.3 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Thon", Price = 3 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Sushi", Price = 5 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Pêche", Price = 0.5 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Cocombre", Price = 1.63 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Vanille", Price = 2.47 });
            bdd.T_Ingredient.Add(new CIngredient { Name = "Vodka", Price = 25.3 });
